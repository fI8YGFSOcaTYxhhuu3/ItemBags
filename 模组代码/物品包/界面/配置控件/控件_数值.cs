...
public class 类型_控件_数值 : UIElement {
    ...
    private readonly UITextPanel<string> 减号按钮;
    private readonly UITextPanel<string> 加号按钮;
    ...
    public 类型_控件_数值( Action<int> 设置器, int 初始数值, int 最小值, int 最大值 ) {
        ...
        减号按钮 = new( "-" ) { TextHAlign = 0.5f, VAlign = 0.5f, BackgroundColor = new( 73, 94, 171 ) };
        ...
        加号按钮 = new( "+" ) { TextHAlign = 0.5f, VAlign = 0.5f, BackgroundColor = new( 73, 94, 171 ) };
    ...
    public override void Draw( SpriteBatch spriteBatch ) {
        ...
        if ( IsMouseHovering || 拖拽状态 ) Utils.DrawBorderString( spriteBatch, 当前数值.ToString(), new( Main.mouseX, Main.mouseY - 20 ), Color.White, 0.8f );
    }
}