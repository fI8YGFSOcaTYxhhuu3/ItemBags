...
// 简单重写成员
public partial interface 接口_嵌套包 : 接口_物品包<类型_配置_嵌套包, 类型_玩家_物品包, 类型_包槽位_嵌套>, 接口_缓存包_可切换<类型_缓存_嵌套包, 类型_配置_嵌套包, 类型_玩家_物品包, 类型_包槽位_嵌套> {
    ...
    类型_包槽位_嵌套 接口_物品包<类型_配置_嵌套包, 类型_玩家_物品包, 类型_包槽位_嵌套>.界面槽位( int 索引 ) => new( this, 索引 );
}
...
public partial interface 接口_嵌套包 {
    ...
    void 接口_缓存包_可切换.切换启用状态() { if ( 启用状态 ) 玩家缓存标记(); 切换启用状态_缓存包_可切换(); if ( 启用状态 ) 玩家缓存标记(); }
}
...
public class 类型_嵌套包 : 类型_缓存包<类型_缓存_嵌套包, 类型_配置_嵌套包, 类型_玩家_物品包, 类型_包槽位_嵌套>, 接口_嵌套包;