...
// 特征重写函数
public partial interface 接口_缓存包<类型_缓存数据, 泛型_配置, 泛型_玩家, 泛型_包槽位> : 接口_缓存包<类型_缓存数据>, 接口_物品包<泛型_配置, 泛型_玩家, 泛型_包槽位> where 泛型_配置 : 类型_配置_物品包 where 泛型_玩家 : 类型_玩家_物品包 where 泛型_包槽位 : 类型_包槽位_物品 {
    接口_物品包<泛型_配置, 泛型_玩家, 泛型_包槽位> 接口_物品包<泛型_配置, 泛型_玩家, 泛型_包槽位>.Clone( 接口_物品包<泛型_配置, 泛型_玩家, 泛型_包槽位> 初始副本 ) { var 副本 = Clone_物品包( 初始副本 ) as 接口_缓存包<类型_缓存数据>; 副本.脏标记 = true; 副本.缓存数据 = default; return 副本 as 接口_物品包<泛型_配置, 泛型_玩家, 泛型_包槽位>; }
    void 接口_物品包.更新容量() { 更新容量_物品包(); 脏标记 = true; }
    void 接口_物品包<泛型_配置, 泛型_玩家, 泛型_包槽位>.LoadData( TagCompound 存档标签 ) => LoadData_缓存包( 存档标签 );
    protected void LoadData_缓存包( TagCompound 存档标签 ) { LoadData_物品包( 存档标签 ); 脏标记 = true; }
    void 接口_物品包<泛型_配置, 泛型_玩家, 泛型_包槽位>.NetReceive( BinaryReader 网络流 ) => NetReceive_缓存包( 网络流 );
